...
Report bugs at <https://github.com/n8henrie/pdupes/issues>.
...
pdupes could always use more documentation,
whether as part of the official pdupes docs,
in docstrings, or even on the web in blog posts, articles, and such.

### Submit Feedback

The best way to send feedback is to file an issue at
<https://github.com/n8henrie/pdupes/issues>.
...
Ready to contribute? Here's how to set up pdupes
for local development.

1.  Fork the pdupes repo on GitHub.
1.  Clone your fork locally:

        $ git clone git@github.com:your_name_here/pdupes.git
